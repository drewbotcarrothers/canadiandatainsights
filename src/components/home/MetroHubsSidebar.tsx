...
export default function MetroHubsSidebar({ cities }: { cities: City[] }) {
  ...
  return (
    <aside className="bg-surface-container-low rounded-xl flex flex-col max-h-[600px]">
      <div className="p-6 bg-surface-container-highest rounded-t-xl">
      ...
      <div className="overflow-y-auto p-4 flex flex-col gap-3 no-scrollbar">
        {cities.map((city, index) => (
          <Link
            ...
            className={`bg-surface-container-lowest p-4 rounded-lg text-left group hover:bg-[#d3e4ff] transition-all ${
              index === 0 ? "border-l-4 border-tertiary" : ""
            } block`}
          >
            <div className="flex justify-between items-start mb-1">
              <span className="font-bold text-on_surface group-hover:text-primary transition-colors font-manrope">
            ...
            <div className="flex gap-4 text-xs text-on_surface-variant font-medium">
      ...
      <div className="mt-auto p-4 bg-surface-container-low border-t border-outline-variant/10">
        <Link
          href="/compare"
          className="w-full bg-primary text-white py-3 rounded-lg font-bold text-sm hover:bg-primary-container transition-all flex items-center justify-center gap-2"
        >
